...
from common.structs import DeviceCall


def _process_device_call(device_commands: list[DeviceCall]):
    """
    根据设备操作名称和参数处理设备调用。
    """
...
@tool
def device_call(device_commands: list[DeviceCall], tool_call_id: Annotated[str, InjectedToolCallId]):
    """
    提供模型操作设备
    """
    return Command(
